...
const rawMbtiBlocks = [
  ...
  { id: 3, pair: 'EI', A: { l: 'E', t: 'Geralmente inicio conversas e me sinto à vontade sendo o centro das atenções em eventos da empresa.' }, B: { l: 'I', t: 'Prefiro observar primeiro e me engajar em conversas profundas com uma ou duas pessoas conhecidas.' } },
  ...
  { id: 19, pair: 'TF', A: { l: 'T', t: 'É mais frequente que eu seja visto como alguém justo, analítico e de mentalidade firme.' }, B: { l: 'F', t: 'É mais frequente que eu seja visto como alguém acolhedor, compreensivo e de mentalidade humanizada.' } },
  ...
  { id: 28, pair: 'JP', A: { l: 'J', t: 'Uma decisão ruim é preferível à angústia de ficar em cima do muro; o negócio é definir logo e avançar.' }, B: { l: 'P', t: 'Fechamento prematuro é um erro; é preferível reabrir o caso e estender a avaliação quando surgem novos dados.' } },
];
