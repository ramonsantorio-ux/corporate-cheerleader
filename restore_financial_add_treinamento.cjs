...
let oldCode = fs.readFileSync('old_EvolucaoContrato.tsx', 'utf16le'); 
if (!oldCode.includes('import')) {
  oldCode = fs.readFileSync('old_EvolucaoContrato.tsx', 'utf8');
}
...
console.log('Restauração completada sem corromper código.');
